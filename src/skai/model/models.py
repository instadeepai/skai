...
class ResNet50v1(tf.keras.Model):
  ...
  def __init__(self,
    ...
    self.resnet_model = tf.keras.applications.resnet50.ResNet50(
        ...
        pooling='avg'
        # TODO(jlee24): Consider making pooling method a flag.
    )
...
class TwoTower(tf.keras.Model):
  ...
  def __init__(self,
    ...
    dense = tf.keras.Sequential([
        # TODO(mohammedelfatihsalah): Add a hyperparameter for dropout.
        tf.keras.layers.Dropout(0.5),
        # TODO(mohammedelfatihsalah): Add a hyperparameter for embedding size.
